...
class Path2<a,c,A : RedisNode<a>, B : RedisRelation<a, c,A, C>, C : RedisNode<c>>
    (val first: A, private val firstToSecond: B, val second: C) : Path {
    operator fun <e, E : RedisNode<e>, D : RedisRelation<c, e, C, E>, W : RelationAttribute<c, e, C, E, D>> minus(scope: C.() -> W) =
